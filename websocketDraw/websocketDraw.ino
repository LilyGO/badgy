...
{  
  ...
  pinMode(39,INPUT_PULLUP); //center
...
void loop()
{
  ...
  byte reading =  (digitalRead(37)  == 0 ? 0 : (1<<0)) | //down
                  (digitalRead(38)  == 0 ? 0 : (1<<1)) | //left
                  (digitalRead(39)  == 0 ? 0 : (1<<2));  //center
        ...
        if(bitRead(buttonState, i) == 0){
          switch(i){
            case 0:
              ...
              showText("You pressed the 2 button!");
              break;
            case 1:
              //do something when the user presses left
              showText("You pressed the 1 button!");
              break;
            case 2:
              //do something when the user presses center
              showText("You pressed the 3 button!");              
            default:
              break;
          }
        }
